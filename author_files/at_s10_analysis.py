# -*- coding: utf-8 -*-
"""at_s10_analysis.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1ycYMbsEegfE1DJJA7D2txAnA4L5Hnx_C
"""
...
model = AutoModelForCausalLM.from_pretrained("/content/drive/MyDrive/adventuretime/at_s10_model")
tokenizer = AutoTokenizer.from_pretrained("/content/drive/MyDrive/adventuretime/at_s10_model")
...
df.to_csv('at_s10_female_bias.csv')
...
df.to_csv('at_s10_male_bias.csv')
...
df.to_csv('at_s10_person_bias.csv')
...
for i in Finn_is:
    out = i[0]['generated_text']
    at_s10_Finn_is.append(out)

df = pd.DataFrame({
    'generated text' : at_s10_Finn_is,
})

df.to_csv('at_s10_Finn_is.csv')
...
for i in Finn_is_not:
    out = i[0]['generated_text']
    at_s10_Finn_is_not.append(out)

df = pd.DataFrame({
    'generated text' : at_s10_Finn_is_not,
})

df.to_csv('at_s10_Finn_is_not.csv')
...
for i in Finn_thinks:
    out = i[0]['generated_text']
    at_s10_Finn_thinks.append(out)

df = pd.DataFrame({
    'generated text' : at_s10_Finn_thinks,
})

df.to_csv('at_s10_Finn_thinks.csv')
...
at_s10_Finn_does_not_think = []

for i in Finn_does_not_think:
    out = i[0]['generated_text']
    at_s10_Finn_does_not_think.append(out)

df = pd.DataFrame({
    'generated text' : at_s10_Finn_does_not_think,
})

df.to_csv('at_s10_Finn_does_not_think.csv')
...
at_s10_Finns_emotions_are = []

for i in Finns_emotions_are:
    out = i[0]['generated_text']
    at_s10_Finns_emotions_are.append(out)

df = pd.DataFrame({
    'generated text' : at_s10_Finns_emotions_are,
})

df.to_csv('at_s10_Finns_emotions_are.csv')
...
at_s10_Finns_emotions_are_not = []

for i in Finns_emotions_are_not:
    out = i[0]['generated_text']
    at_s10_Finns_emotions_are_not.append(out)

df = pd.DataFrame({
    'generated text' : at_s10_Finns_emotions_are_not,
})

df.to_csv('at_s10_Finns_emotions_are_not.csv')

at_s10_Finns_emotions_are_not

at_s10_outputs_all = female_bias + male_bias + person_bias + at_s10_Finn_is + at_s10_Finn_is_not + at_s10_Finn_thinks + at_s10_Finn_does_not_think + at_s10_Finns_emotions_are + at_s10_Finns_emotions_are_not

df = pd.DataFrame({
    'generated text' : at_s10_outputs_all ,
})

df.to_csv('at_s10_outputs_all .csv')
